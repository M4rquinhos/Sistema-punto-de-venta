...
namespace Sistema.Presentacion
{
    public partial class FrmVista_ProveedorIngreso : Form
    {
        ...
        {
            //Variables.IdUsuario = ;
            Variables.IdProveedor = Convert.ToInt32(dtgListado.CurrentRow.Cells["ID"].Value);
            Variables.NombreProveedor = Convert.ToString(dtgListado.CurrentRow.Cells["Nombre"].Value);
            this.Close();
        }
    }
}
